...
alert-level-green-taipan = Зелёный
alert-level-green-taipan-announcement = Можно безопасно возвращаться на свои рабочие места.
alert-level-green-taipan-instructions = Выполняйте свою работу.
alert-level-yellow-taipan = Жёлтый
alert-level-yellow-taipan-announcement = На станции присутствует структурная или атмосферная угроза. Инженерно-техническому персоналу рекомендуется немедленно реагировать и предпринимать меры по обеспечению безопасности. Членам экипажа рекомендуется удалиться от угрозы и при необходимости оставаться на своих рабочих местах.
alert-level-yellow-taipan-instructions = Членам экипажа необходимо в срочном порядке покинуть опасную зону и, по возможности, оставаться на своих рабочих местах.
...
alert-level-white-instructions = Проявляйте повышенную бдительность. Все подозрительные объекты/обломки должны быть взяты штурмом/уничтожены.
...
alert-level-zeta-instructions = Соответствующему персоналу требуется незамедлительно приступить к ликвидации биологической угрозы.
alert-level-omega = Омега
alert-level-omega-announcement = Существование и контроль сектора Синдикатом под угрозой. Высший командный состав имеет право применять летальную силу при неподчинении. Покидать пределы территории объекта запрещено. Весь персонал обязан иметь при себе тяжёлое вооружение. Все стыковочные порты должны быть изолированы.
alert-level-omega-instructions = Лимиты на вооружение сняты. Все сотрудники обязаны получить тяжёлое вооружение.
...
alert-level-audit-instructions = Все сотрудники должны начать уборку своих рабочих мест.
